...
#Region "ucStatGenerali"
    Public Function loadTabellaRisposte(ByVal oDomanda As Domanda) As Table
        Select Case oDomanda.tipo
            ...
            Case Domanda.TipoDomanda.RatingStars    'Ok
                'Return CreateTableForRatingQuestion(oDomanda)
                Return CreateTableForRatingStarsQuestion(oDomanda) 'NOTA: al momento è uguale a quella rating normale: copia incolla, tenuta diversa per metterci le stelline, eventualmente.
            Case Domanda.TipoDomanda.Meeting
