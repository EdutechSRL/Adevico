...
#End Region
    ...
    Private Sub UpdatePreview(itemType As FieldType, disclaimerType As DisclaimerType)
        ...
        If itemType = FieldType.CheckboxList OrElse itemType = FieldType.DropDownList OrElse itemType = FieldType.RadioButtonList OrElse disclaimerType = lm.Comol.Modules.CallForPapers.Domain.DisclaimerType.CustomMultiOptions OrElse disclaimerType = lm.Comol.Modules.CallForPapers.Domain.DisclaimerType.CustomSingleOption Then
    ...
    Private Sub UpdateCssClass(itemType As FieldType)
        ...
        Select Case itemType
            Case FieldType.CheckboxList, FieldType.DropDownList, FieldType.MultiLine, FieldType.Note, FieldType.RadioButtonList, FieldType.SingleLine
