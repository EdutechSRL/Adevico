...
#End Region
    ...
    Private Sub RPTsubmissions_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles RPTsubmissions.ItemDataBound
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            'If revStatus = RevisionStatus.None OrElse revStatus = RevisionStatus.Approved Then
            oHyperlink.NavigateUrl = BaseUrl & RootObject.ViewSubmissionAsManager(CallType, IdCall, dto.Submission.Id, dto.Submission.IdRevision, dto.Submission.UniqueID, False, CurrentView, Me.CurrentFilterBy, CurrentOrderBy, CurrentAscending, Pager.PageIndex, PageSize)
            'Else
    ...
    Protected Sub RPTrevisions_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        ...
        If dto.isActive Then
            oHyperlink.NavigateUrl = BaseUrl & RootObject.ViewSubmissionAsManager(CallType, IdCall, dto.Submission.Id, dto.Id, dto.Submission.UniqueID, False, CurrentView, Me.CurrentFilterBy, CurrentOrderBy, CurrentAscending, Pager.PageIndex, PageSize)
        Else
