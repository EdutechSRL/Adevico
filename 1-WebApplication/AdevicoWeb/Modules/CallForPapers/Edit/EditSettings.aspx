                                    ...
                                    <div class="fieldrow fielddaterange">
                                     ...
                                     <div class="fieldrow fieldendtime">
                                         <span class="description">
                                            <asp:Label ID="LBoverrideData" runat="server">SE l'utente inizia a sottomettere la domanda prima dei termini di consegna MA durante la procedura di sottomissione scadono, consenti all'utente di completare la propria domanda entro</asp:Label>
                                     ...
                                     <div class="fieldrow fieldextratime">
                                         <asp:CheckBox ID="CBXallowExtensionDate" runat="server" CssClass="inputtext" />
                                         <asp:Label ID="LBallowExtensionDate" runat="server" AssociatedControlID="CBXallowExtensionDate" CssClass="inline">Consenti di prolungare i tempi di sottomissione per alcuni utente OLTRE il termine di scadenza</asp:Label>
                                    </div>
