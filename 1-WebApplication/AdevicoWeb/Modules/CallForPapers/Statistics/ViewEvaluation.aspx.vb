...
#Region "Display"
    ...
    Private Sub DisplaySessionTimeout() Implements lm.Comol.Modules.CallForPapers.Presentation.IViewBase.DisplaySessionTimeout
        If PreloadIdEvaluation > 0 Then
            DisplaySessionTimeout(RootObject.ViewSingleEvaluation(PreloadIdEvaluation, PreloadIdSubmission, PreloadIdCall, PreloadIdCommunity))
        ElseIf PreloadIdEvaluator > 0 Then
            DisplaySessionTimeout(RootObject.ViewUserEvaluations(PreloadIdEvaluator, PreloadIdSubmission, PreloadIdCall, PreloadIdCommunity))
        Else
            DisplaySessionTimeout(RootObject.ViewSubmissionEvaluations(PreloadIdSubmission, PreloadIdCall, PreloadIdCommunity))
        End If
    End Sub
...
#End Region
    ...
    Private Sub SetViewEvaluationUrl(url As String) Implements IViewViewEvaluation.SetViewEvaluationUrl
        HYPviewTableEvaluation.Visible = Not String.IsNullOrEmpty(url)
        ...
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Select Case CurrentEvaluationType
                Case EvaluationType.Average
                    oLabel.Text = item.AverageRating
                Case EvaluationType.Dss
                    ...
                    End If
                Case Else
                    oLabel.Text = item.Evaluation.SumRating
            End Select
