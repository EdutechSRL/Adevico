...
#End Region
    ...
    End Sub
    Private Sub LoadSubmissionInfo(callName As String, submitterName As String, submittedOn As Date?, submittedBy As String, committees As List(Of lm.Comol.Modules.CallForPapers.Domain.Evaluation.dtoCommitteeEvaluationInfo), idCommittee As Long) Implements IViewEvaluationSummary.LoadSubmissionInfo
        ...
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Else
                ...
                Else
                    ...
                    oHyperLink.ToolTip = Resource.getValue("ViewEvaluation")
                    oHyperLink.NavigateUrl = BaseUrl & RootObject.ViewUserEvaluations(dto.IdEvaluator, IdSubmission, IdCall, IdCallCommunity)
                End If
