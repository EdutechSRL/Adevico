                            ...
                            <ItemTemplate>
                                <tr id="subm-<%#Container.DataItem.Id %>" class="submitter">
                                    ...
                                    <asp:Repeater ID="RPTcriteriaEvaluated" runat="server" DataSource="<%#Container.DataItem.Criteria %>" OnItemDataBound="RPTcriteriaEvaluated_ItemDataBound">
                                        <ItemTemplate>
                                            <td class="evaluator"><asp:label ID="LBcriterionEvaluated" runat="server"></asp:label><CTRL:CTRLfuzzyNumber id="CTRLfuzzyNumber" runat="server"></CTRL:CTRLfuzzyNumber></td>    
                                        </ItemTemplate>
                                    </asp:Repeater>
