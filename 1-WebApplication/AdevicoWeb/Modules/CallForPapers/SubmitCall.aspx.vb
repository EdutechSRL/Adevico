...
#Region "Repeater binding"
    ...
    Protected Sub OnRemoveFile(ByVal idSubmitted As Long)
        Me.CurrentPresenter.RemoveSubmittedFile(idSubmitted, GetValues())
    End Sub
...
#End Region
    ...
    Private Sub BTNsaveSubmissionBottom_Click(sender As Object, e As System.EventArgs) Handles BTNsaveSubmissionBottom.Click, BTNsaveSubmissionTop.Click
        ...
        Me.CurrentPresenter.SaveSubmission(GetValues())
    End Sub
    ...
    Private Sub BTNsubmitSubmissionBottom_Click(sender As Object, e As System.EventArgs) Handles BTNsubmitSubmissionBottom.Click, BTNsubmitSubmissionTop.Click
       ...
       Dim sTranslations As New Dictionary(Of lm.Comol.Modules.CallForPapers.Domain.SubmissionTranslations, String)
        ...
        Me.CurrentPresenter.SaveCompleteSubmission(GetValues(), PageUtility.CurrentSmtpConfig, PageUtility.ApplicationUrlBase, sTranslations, baseFilePath, Me.Resource.getValue("SubmissionTranslations." & SubmissionTranslations.FilesSubmitted.ToString))
    End Sub
