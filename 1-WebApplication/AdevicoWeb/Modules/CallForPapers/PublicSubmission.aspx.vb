...
#Region "Implements"
    ...
    Private Sub DisplaySessionTimeout() Implements IViewViewPublicSubmission.DisplaySessionTimeout
        Dim url As String = ""
        url = RootObject.ViewSubmission(CallForPaperType.CallForBids, PreloadIdCall, PreloadedIdSubmission, PreloadedUniqueID, True, FromPublicList, PreloadView, PreloadIdOtherCommunity)
    ...
    Private Sub InitializeExportControl(isOwner As Boolean, idUser As Integer, idCall As Long, idSubmission As Long, idRevision As Long, idModule As Integer, idCallCommunity As Integer, callType As CallForPaperType) Implements IViewViewPublicSubmission.InitializeExportControl
