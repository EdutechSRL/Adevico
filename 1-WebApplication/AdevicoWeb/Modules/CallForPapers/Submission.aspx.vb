...
#Region "Implements"
    ...
    Private Sub DisplaySessionTimeout() Implements IViewViewSubmission.DisplaySessionTimeout
        ...
        Else
            url = RootObject.ViewSubmission(CallType, PreloadIdCall, PreloadedIdSubmission, PreloadedUniqueID, False, False, PreloadView, PreloadIdOtherCommunity)
        End If
    ...
    Private Sub InitializeExportControl(isOwner As Boolean, idUser As Integer, idCall As Long, idSubmission As Long, idRevision As Long, idModule As Integer, idCallCommunity As Integer, callType As CallForPaperType) Implements IViewViewSubmission.InitializeExportControl
    ...
    Private Sub SetActionUrl(action As CallStandardAction, url As String) Implements IViewViewSubmission.SetActionUrl
        Select Case action
            ...
            Case CallStandardAction.Manage
                Me.HYPsubmissionsList.NavigateUrl = BaseUrl & url
