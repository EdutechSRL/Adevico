        ...
        Else
            ...
            If stat.userCount > -1 Then
                ...
                If Not IsEvaluable Then
                    ...
                    HYPdetail.Text = ""
                    HYPdetail.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UsersStatistics(PathID, Me.CurrentCommunityID, ItemType.Path, 0, TimeStat, CHBshowall.Checked, IsMoocPath)
            ...
            HYPcertificates.NavigateUrl = Me.BaseUrl + RootObjectMoocs.EPCertificationList(CurrentCommunityID, PathID, IsMoocPath)
...
#End Region
    ...
    Public Sub LoadCertifiedDate() Handles CTRLselTime.ViewCertifiedStat
        ...
        RedirectToUrl(RootObjectMoocs.PathStatistics(PathID, CurrentCommunityID, EpEndDate, CHBshowall.Checked, IsMoocPath))

    End Sub

    Private Sub ReloadStat(ByVal dateToView As DateTime?) Handles CTRLselTime.DateSelected
        RedirectToUrl(RootObjectMoocs.PathStatistics(PathID, CurrentCommunityID, dateToView, CHBshowall.Checked, IsMoocPath))
    End Sub
    ...
    Private Sub InitHyperLink()
        ...
        ''Me.HYPuserStat.ImageUrl = RootObjectMoocs.ImgUsersStat(Me.BaseUrl)
        Me.HYPuserStat.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UsersStatistics(Me.PathID, Me.CurrentCommunityID, ItemType.Path, 0, TimeStat, CHBshowall.Checked, IsMoocPath)

        Me.HYPeduPathList.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(Me.CurrentCommunityID, EpViewModeType.Manage, IsMoocPath)

        Me.HYPeduPathView.NavigateUrl = Me.BaseUrl & RootObjectMoocs.PathView(PathID, Me.CurrentCommunityID, EpViewModeType.Manage, ServiceEP.isPlayModePath(PathID), IsMoocPath)
    End Sub
    ...
    Private Sub ShowError(ByVal errorType As EpError)
        ...
        Me.HYPerror.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(Me.CurrentCommunityID, Me.ViewModeType, IsMoocPath)
    ...
    '                oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UsersStat(dtoItem.itemId, Me.CurrentCommunityID, ItemType.Unit, 0, TimeStat)
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If dtoItem.userCount > -1 Then
                ...
                If Not IsEvaluable Then
                    ...
                    Me.Resource.setHyperLink(oHyp, False, True)
                    oHyp.Text = ""
                    oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UsersStatistics(dtoItem.itemId, Me.CurrentCommunityID, ItemType.Activity, 0, TimeStat, CHBshowall.Checked, IsMoocPath)
                    oHyp.Visible = True
                End If
    ...
    Private Sub RPsubAct_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If ServiceEP.isSubActityInternalModule(dtoItem.ContentType) Then
                ...
                Select Case dtoItem.SubActivity.ContentType
                    ...
                    Case SubActivityType.Certificate
                        ...
                        ohypStat.NavigateUrl = Me.BaseUrl & RootObjectMoocs.PathSubActivityCertifications(PathID, dtoItem.SubActivity.Id, Me.CurrentCommunityID, TimeStat, IsMoocPath)
            ...
            Else
                ...
                'Dim oDisplayAction As lm.Comol.Core.DomainModel.Common.iModuleActionView = CType(LoadControl(BaseUrl & lm.Comol.Core.DomainModel.Common.CoreRootObjectMoocs.GenericDisplayActionControl), lm.Comol.Core.DomainModel.Common.iModuleActionView)
            ...
            If dtoItem.userCount > -1 Then
                ...
                If IsEvaluable Then
                    ...
                    'oHyp.Visible = True
                    'Me.Resource.setHyperLink(oHyp, False, True)
                    'oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EvaluateSubAct(dtoItem.itemId, Me.CurrentCommunityID, EvaluationFilter.NotEvaluated, EpEndDate)
                ...
                Else
                    ...
                    Me.Resource.setHyperLink(oHyp, False, True)
                    oHyp.Text = ""
                    oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UsersStatistics(dtoItem.itemId, Me.CurrentCommunityID, ItemType.SubActivity, 0, TimeStat, CHBshowall.Checked, IsMoocPath)
    ...
    Private Sub SetBlockedStatusLkb(ByRef oLkb As LinkButton, ByVal isBlocked As Boolean, ByRef itemID As Long)
        ...
        'oLkb.Text = String.Format(oLkb.Text, RootObjectMoocs.ImgBtnBlocked(Me.BaseUrl, Not isBlocked), oLkb.ToolTip)
    ...
    Private Sub InitStackedBar(ByRef ImgGreen As System.Web.UI.WebControls.Image, ByRef ImgYellow As System.Web.UI.WebControls.Image, ByRef ImgRed As System.Web.UI.WebControls.Image, ByRef dtoItemStat As dtoGenericGlobalStat)
        ...
        '    ImgGreen.ImageUrl = RootObjectMoocs.ImgRectangleGreen(Me.BaseUrl)
        ...
        'If started > 0 Then
        '    ImgYellow.ImageUrl = RootObjectMoocs.ImgRectangleYellow(Me.BaseUrl)
        ...
        '    ImgRed.ImageUrl = RootObjectMoocs.ImgRectangleRed(Me.BaseUrl)
        '    ImgRed.Visible = True
            ...
            If dtoItem.userCount > -1 Then
                ...
                If Not isAutoEp Then
                    ...
                    If Not IsEvaluable Then
                        ...
                        Me.Resource.setHyperLink(oHyp, False, True)
                        oHyp.Text = ""
                        oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UsersStatistics(dtoItem.itemId, Me.CurrentCommunityID, ItemType.Unit, 0, TimeStat, CHBshowall.Checked, IsMoocPath)
