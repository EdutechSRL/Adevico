...
Public Class EPSummaryIndexMooc
...
#Region "Inherits"
    Public Overrides Sub BindDati()
        ...
        'setHref(Asummaryuser) = Me.BaseUrl + RootObjectMoocs.SearchUsersForModule(Service.ModuleCode, "summaryIndex", CmntId)

        'setHref(Asummarycommunity) = Me.BaseUrl + RootObjectMoocs.EpSummaryCommunity

        'setHref(Asummaryorganization) = Me.BaseUrl + RootObjectMoocs.EpSummaryOrganization

        'setHref(Asummarypath) = Me.BaseUrl + RootObjectMoocs.EpSummaryPath

        'Asummaryuser.Attributes("href") = Me.BaseUrl + RootObjectMoocs.SearchUsersForModule(Service.ModuleCode, "summaryIndex", CmntId)
...
#Region "Implements"
    ...
    Private Sub DisplaySessionTimeout() Implements IViewSummaryIndex.DisplaySessionTimeout
        ...
        dto.DestinationUrl = lm.Comol.Modules.EduPath.BusinessLogic.RootObjectMoocs.SummaryIndex(PreloadSummaryType, PreloadIdCommunity)
        ...
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Select Case st
                Case lm.Comol.Modules.EduPath.Domain.SummaryType.Community
                    oControl.HRef = BaseUrl & lm.Comol.Modules.EduPath.BusinessLogic.RootObjectMoocs.SummaryCommunity(SummaryType, SummaryIdCommunity)
                Case lm.Comol.Modules.EduPath.Domain.SummaryType.Organization
                    oControl.HRef = BaseUrl & lm.Comol.Modules.EduPath.BusinessLogic.RootObjectMoocs.SummaryOrganization(SummaryType, SummaryIdCommunity)
                Case lm.Comol.Modules.EduPath.Domain.SummaryType.Path
                    oControl.HRef = BaseUrl & lm.Comol.Modules.EduPath.BusinessLogic.RootObjectMoocs.SummaryPath(SummaryType, SummaryIdCommunity)
                Case lm.Comol.Modules.EduPath.Domain.SummaryType.User
                    oControl.HRef = BaseUrl & lm.Comol.Modules.EduPath.BusinessLogic.RootObjectMoocs.SearchUsersForModule(SummaryType, SummaryIdCommunity)
                Case Else
                    oControl.HRef = "#"
            End Select
        End If
