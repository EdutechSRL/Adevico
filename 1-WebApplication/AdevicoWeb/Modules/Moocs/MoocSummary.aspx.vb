...
#End Region
    ...
    Public Overrides Sub BindDati()
        ...
        Me.HYPlistEduPath.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(Me.CurrentCommunityID, EpViewModeType.Manage, PreloadIsMooc)
    ...
    Private Sub RPTusers_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles RPTusers.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            hyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UserPathSummary(dto.Person.Id, CmntId, Pager.PageIndex, Server.UrlEncode(orole), Server.UrlEncode(name), PreloadIsMooc)
            ...
            If UniquePath Then
                ...
                If (dto.Paths.Count > 0) Then
                    ...
                    oHyp.Text = ""
                    oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UserStatisticsManage(dtoUnique.IdPath, Me.CurrentCommunityID, dtoUnique.IdPerson, ItemType.Path, 0, DateTime.Now, CHBshowall.Checked, PreloadIsMooc)
                Else
                    hyp = e.Item.FindControl("HYPinfo")
                    hyp.Visible = False
    ...
    Private Sub RPTpaths_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            Me.Resource.setHyperLink(oHyp, False, True)
            oHyp.Text = ""
            oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UserStatisticsManage(dto.IdPath, Me.CurrentCommunityID, dto.IdPerson, ItemType.Path, 0, DateTime.Now, CHBshowall.Checked, True, PreloadIsMooc)
            'Me.GetDetailUrl(dtoItem.UserId)

            oHyp = e.Item.FindControl("HYPcertificates")
            Me.Resource.setHyperLink(oHyp, False, True)
            oHyp.Text = ""
            oHyp.NavigateUrl = Me.BaseUrl + RootObjectMoocs.EPCertificationUser(dto.IdCommunity, dto.IdPath, dto.IdPerson, dto.IsMooc)
