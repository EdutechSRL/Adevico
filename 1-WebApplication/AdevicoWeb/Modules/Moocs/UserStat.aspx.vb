...
#End Region
    ...
    Private Sub InitHyperLink()
        ...
        Select Case Me.ViewModeType
            ...
            Case EpViewModeType.Manage
                'Me.HYPpathStat.ImageUrl = RootObjectMoocs.ImgEduPathStat(Me.BaseUrl)
                Me.HYPpathStat.Visible = True
                Me.HYPpathStat.NavigateUrl = Me.BaseUrl & RootObjectMoocs.PathStatistics(PathID, Me.CurrentCommunityID, TimeStat, PreloadShowAll, True)

                'Me.HYPuserStat.ImageUrl = RootObjectMoocs.ImgUsersStat(Me.BaseUrl)
                Me.HYPuserStat.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UsersStatistics(Me.PathID, Me.CurrentCommunityID, ItemType.Path, PageIndex, TimeStat, PreloadShowAll, True)

                Me.HYPback.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UsersStatistics(ItemId, CurrentCommunityID, Type, PageIndex, TimeStat, PreloadShowAll, True)

            Case EpViewModeType.View
                Me.HYPback.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(Me.CurrentCommunityID, EpViewModeType.View, True)


        End Select
        Me.HYPeduPathView.NavigateUrl = Me.BaseUrl & RootObjectMoocs.PathView(PathID, Me.CurrentCommunityID, Me.ViewModeType, ServiceEP.isPlayModePath(PathID), True)
    ...
    Private Sub InitPathStat(ByRef pathStat As dtoItemWithStatistic)
        ...
        If pathStat.TotMandatory > 0 Then
            ...
            IMGmandatory.ImageUrl = RootObjectMoocs.ImgMandatorySubItem(Me.BaseUrl)
    ...
    Private Sub ShowError(ByVal errorType As EpError)
        ...
        Me.HYPerror.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(Me.CurrentCommunityID, Me.ViewModeType, True)
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If Not isAutoEp Then
                ...
                If dtoItem.TotMandatory > 0 Then
                    ...
                    oImg.Visible = True
                    oImg.ImageUrl = RootObjectMoocs.ImgMandatorySubItem(Me.BaseUrl)
    ...
    Private Sub SetImgColor(ByRef oImg As System.Web.UI.WebControls.Image, ByRef isRed As Boolean, Optional ByVal toolTip As String = "")
        If isRed Then
            oImg.ImageUrl = RootObjectMoocs.ImgRed(Me.BaseUrl)
        Else
            oImg.ImageUrl = RootObjectMoocs.ImgGreen(Me.BaseUrl)
        End If
    ...
    Private Sub ReloadStat(ByVal dateToView As DateTime?) Handles CTRLselTime.DateSelected
        If ViewModeType = EpViewModeType.Manage Then
            RedirectToUrl(RootObjectMoocs.UserStatisticsManage(PathID, CurrentCommunityID, UserToViewStat, ItemType.Path, PageIndex, dateToView, PreloadShowAll, PreloadAutoUpdate, True))
        Else
            RedirectToUrl(RootObjectMoocs.UserStatisticsView(PathID, CurrentCommunityID, dateToView, PreloadShowAll, True))
    ...
    Public Sub LoadCertifiedDate() Handles CTRLselTime.ViewCertifiedStat
        ...
        If ViewModeType = EpViewModeType.Manage Then
            RedirectToUrl(RootObjectMoocs.UserStatisticsManage(PathID, CurrentCommunityID, UserToViewStat, ItemType.Path, PageIndex, EpEndDate, PreloadShowAll, PreloadAutoUpdate, True))
        Else
            RedirectToUrl(RootObjectMoocs.UserStatisticsView(PathID, CurrentCommunityID, EpEndDate, PreloadShowAll, True))
    ...
    Public Sub RPactivity_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If ViewModeType = EpViewModeType.Manage Then
                oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UserActivityStatManage_PrevUsersStat(PathID, dtoItem.Id, CurrentCommunityID, UserToViewStat, TimeStat, PreloadShowAll, True)
            Else
                oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UserActivityStatView(PathID, dtoItem.Id, CurrentCommunityID, Me.TimeStat, PreloadShowAll, True)
            End If
