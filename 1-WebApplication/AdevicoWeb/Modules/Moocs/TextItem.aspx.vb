...
#Region "Inherits"
    Public Overrides Sub BindDati()
        ...
        Me.HYPerror.NavigateUrl = Me.BaseUrl & RootObjectMoocs.PathView(PathId, Me.CurrentCommunityID, EpViewModeType.Manage, ServiceEP.isPlayModePath(PathId), IsMoocPath, PreloadIsFromReadOnly)
        Me.InitWizardButton()
...
#Region "Button"
    ...
    Public Sub BTNnext_Click(ByVal sender As Object, ByVal e As EventArgs)
        Select Case Me.CurrentStep
            Case StepTextItem.NewNote
                ...
                End If
                If PersistData() Then
                    PageUtility.RedirectToUrl(RootObjectMoocs.PathView(PathId, CurrentCommunityID, EpViewModeType.Manage, ServiceEP.isPlayModePath(PathId), IsMoocPath, PreloadIsFromReadOnly))
                Else
                ...
                '    _isDraft = False
                '    If PersistData() Then
                '        PageUtility.RedirectToUrl(RootObjectMoocs.PathView(PathId, CurrentCommunityID, EpViewModeType.Manage))
                '    Else
                '        Me.ShowError(EpError.Generic)
                '    End If
            ...
            Case StepTextItem.SelectPermission
                ...
                PageUtility.RedirectToUrl(RootObjectMoocs.TextItem(RealItemId, ParentId, ItemType, CurrentCommunityID, StepTextItem.Update, IsMoocPath, PreloadIsFromReadOnly))


            Case StepTextItem.SelectPerson
                Me.GetSelectedPerson()
                PageUtility.RedirectToUrl(RootObjectMoocs.TextItem(RealItemId, ParentId, ItemType, CurrentCommunityID, StepTextItem.SelectPermission, IsMoocPath, PreloadIsFromReadOnly))
            ...
            Case StepTextItem.Update
                ...
                Text = Me.CTRLeditorDescription.HTML
                If PersistData() Then
                    RedirectToUrl(RootObjectMoocs.PathView(PathId, CurrentCommunityID, EpViewModeType.Manage, ServiceEP.isPlayModePath(PathId), IsMoocPath, PreloadIsFromReadOnly))
                Else
                    Me.ShowError(EpError.Generic)
                End If
        End Select
    ...
    Public Sub BTNprevious_Click(ByVal sender As Object, ByVal e As EventArgs)
        Select Case Me.CurrentStep
            Case StepTextItem.SelectPermission
                Me.SubGetSelectedPermissionByCRole()
                Me.SubGetSelectedPermissionByPerson()
                Me.PageUtility.RedirectToUrl(RootObjectMoocs.UpdateTextItem(RealItemId, ParentId, ItemType, CurrentCommunityID, IsMoocPath, PreloadIsFromReadOnly))

            Case StepTextItem.SelectPerson
                Me.GetSelectedPerson()
                Me.PageUtility.RedirectToUrl(RootObjectMoocs.TextItem(RealItemId, ParentId, ItemType, CurrentCommunityID, StepTextItem.SelectPermission, IsMoocPath, PreloadIsFromReadOnly))
        End Select
    End Sub
    ...
    Public Sub BTNcancel_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        PageUtility.RedirectToUrl(RootObjectMoocs.PathView(Me.PathId, Me.CurrentCommunityID, EpViewModeType.Manage, ServiceEP.isPlayModePath(PathId), IsMoocPath, PreloadIsFromReadOnly))
    ...
    Private Sub BTNselectPerson_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNselectPerson.Click
        Me.SubGetSelectedPermissionByCRole()
        Me.SubGetSelectedPermissionByPerson()
        PageUtility.RedirectToUrl(RootObjectMoocs.TextItem(RealItemId, ParentId, ItemType, CurrentCommunityID, StepTextItem.SelectPerson, IsMoocPath, PreloadIsFromReadOnly))
    End Sub
...
#End Region
    ...
    Private Sub ShowError(ByVal ErrorType As EpError)
        ...
        Me.HYPerror.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(Me.CurrentCommunityID, EpViewModeType.Manage, IsMoocPath)
