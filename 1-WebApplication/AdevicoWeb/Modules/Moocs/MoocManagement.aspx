<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master"
	CodeBehind="MoocManagement.aspx.vb" Inherits="Comunita_OnLine.MoocManagement"
...
<%@ Register Src="~/Modules/EduPath/UC/UC_HelpEpRole.ascx" TagName="CTRLhelpRole" TagPrefix="CTRL" %>
				...
				<asp:Wizard ID="WZRpathCreate" runat="server" ActiveStepIndex="0" Width="100%" BackColor="#EFF3FB"
					...
					<WizardSteps>
						<asp:WizardStep ID="WSTdata" runat="server" Title="*Path Detail" StepType="Step">
							...
							<div id="DIVmoocType" class="DetailItem" runat="server">
								<div class="DetailLeftItem">
									<asp:Label ID="Label1" runat="server" CssClass="Titolo_campoSmall">*Mooc Type:</asp:Label>
								</div>
								<div class="DetailRightItem">
									<asp:radiobuttonlist ID="RBLmoocType" runat="server">
										<asp:ListItem runat="server" Text="*Info" Value="1"/>
										<asp:ListItem runat="server" Text="*Cokade" Value="2" Selected="true"/>
										<asp:ListItem runat="server" Text="*Certification" Value="3"/>
									</asp:radiobuttonlist>
								</div>
							</div>
