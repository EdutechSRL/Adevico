<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="Moocs.aspx.vb" Inherits="Comunita_OnLine.EPmoocsList" %>
    ...
    <asp:MultiView ID="MLVeduPathList" runat="server" ActiveViewIndex="0">
        <asp:View ID="VIWeduPathList" runat="server">
            <div class="DivEpButton">
                <asp:HyperLink ID="HYPnewEp" runat="server" Text="**add ep" CssClass="Link_Menu" Visible="false"></asp:HyperLink>
            ...
            <asp:panel ID="PNLcokadeManage" runat="server">
                <fieldset>
                    <div class="fieldrow title">
                        <div class="description">
                            <CTRL:Switch ID="CTRLswCokade" runat="server" Status="true" Enabled="true" MainCss="btnswitchgroup big"/>
                            <asp:label ID="LBLcokade_desc_t" runat="server">**Attiva o disattiva la coccarda per questa comunità</asp:label>
                        </div>
                    </div>
                </fieldset>
            </asp:panel>
            ...
            <div class="list">
                    ...
                    <li class="path clearfix<%# Me.IsDefaultPath(Container.DataItem)%><%# Me.CssIsBlocked(Container.DataItem)%>" id="PATH-<%# DataBinder.Eval(Container.DataItem,"Id")%>">
                        ...
                        <div class="pathcontainer">
                            ...
                            <div class="pathfooter clearfix">
                                ...
                                <div class="right">
                                    <div class="mookCompletition">
                                        <%--Star:--%>
                                        <asp:literal ID="LTstar" runat="server">
                                            <span class="star {0} {1}">{0}-{1}</span>
                                        </asp:literal>&nbsp;&nbsp;
                                        <span id="DVcompletition" runat="server" class="completitionbarContainer">
                                            <asp:literal ID="LTcompletitionbar" runat="server">
                                                <span class="completitionBar {0}">{1}% (min. {2}%)</span>
                                            </asp:literal>
                                        </span>
                                    </div>
                ...
                <asp:Literal runat="server" id="LTcokadeInfo" Visible="False">
                    <div class="cokadecontainer {0} adv-alert adv-alert-info">
                        <table>
                            <tr>
                                <td style="width:1%;">
                                    <div class="cokadeItem {0}">{0}</div>
                                </td>
                                <td style="width:20px;">
                                    &nbsp;
                                </td>
