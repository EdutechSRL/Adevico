...
#End Region
    ...
    Private Sub InitHyperlink()
        Me.HYPerror.NavigateUrl = Me.BaseUrl & RootObjectMoocs.PathView(CurrentPathId, Me.CurrentCommunityID, EpViewModeType.Manage, ServiceEP.isPlayModePath(CurrentPathId), IsMoocPath, PreloadIsFromReadOnly)

        If Not isAutoEp Then
            If ItemType = lm.Comol.Modules.EduPath.Domain.ItemType.Unit Then
                Me.HYPswitchMode.NavigateUrl = Me.BaseUrl & RootObjectMoocs.Validate(Me.CurrentPathId, Me.CurrentCommunityID, lm.Comol.Modules.EduPath.Domain.ItemType.Activity, IsMoocPath, PreloadIsFromReadOnly)
            ...
            Else
                Me.HYPswitchMode.NavigateUrl = Me.BaseUrl & RootObjectMoocs.Validate(Me.CurrentPathId, Me.CurrentCommunityID, lm.Comol.Modules.EduPath.Domain.ItemType.Unit, IsMoocPath, PreloadIsFromReadOnly)
    ...
    Private Sub ShowError(ByVal ErrorType As EpError)
        ...
        'Me.HYPerror.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(Me.CurrentCommunityID, Me.ViewModeType)
...
#End Region
    ...
    Private Sub LKBeduPathView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LKBeduPathView.Click
        ClearSession()
        PageUtility.RedirectToUrl(RootObjectMoocs.PathView(CurrentPathId, Me.CurrentCommunityID, EpViewModeType.Manage, ServiceEP.isPlayModePath(CurrentPathId), IsMoocPath, PreloadIsFromReadOnly))
    End Sub
