...
Public Class CertificationItemMooc
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.HYPviewActivity.NavigateUrl = Me.BaseUrl & RootObjectMoocs.ViewActivity(ActivityId, UnitId, PathId, CurrentCommunityID, lm.Comol.Modules.EduPath.Domain.EpViewModeType.Manage, IsMoocPath, PreloadIsFromReadOnly)
    ...
    Public Overrides Sub SetCultureSettings()
        MyBase.SetCulture("pg_MoocCertification", "EduPath")
    End Sub
