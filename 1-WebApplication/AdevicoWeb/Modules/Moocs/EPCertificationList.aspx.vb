...
Public Class EPCertificationListMooc
    ...
    Private Sub RPTcertifications_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles RPTcertifications.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            ...
            ohyp.NavigateUrl = Me.BaseUrl + RootObjectMoocs.EPCertification(CurrentPathIdCommunity, CurrentIdPath, dto.CertificateId, IsMoocPath)
    ...
    Public Property OnlyOne As Boolean Implements lm.Comol.Modules.EduPath.Presentation.IViewCertificationList.OnlyOne
        ...
        Set(value As Boolean)
            _onlyone = value
            If (_onlyone) Then
                Response.Redirect(Me.BaseUrl + RootObjectMoocs.EPCertification(CurrentPathIdCommunity, CurrentIdPath, CertificateStats.First().CertificateId, IsMoocPath))
            End If
        End Set
    End Property
