...
#Region "Inherits"
    Public Overrides Sub BindDati()
        ...
        If Not UserIdquery Then
            Me.HYPlistEduPath.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(CmntId, EpViewModeType.View, PreloadIsMooc)
        ...
        Else
            Try
                ...
                If (From = "list") Then
                    Me.HYPback.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(CmntId, EpViewModeType.View, PreloadIsMooc)
                Else
                    Me.HYPback.NavigateUrl = Me.BaseUrl & RootObjectMoocs.PathSummary(CmntId, Me.UserId, 0, page, role, search, PreloadIsMooc)
                End If
            Catch ex As Exception
                If (From = "list") Then
                    Me.HYPback.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(CmntId, EpViewModeType.View, PreloadIsMooc)
                Else
                    Me.HYPback.NavigateUrl = Me.BaseUrl & RootObjectMoocs.PathSummary(CmntId, Me.UserId, 0, PreloadIsMooc)
                End If
            End Try
    ...
    Private Sub RPTpaths_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            ElseIf dto.CanManage Then
                oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UserStatisticsManage(dto.IdPath, Me.CurrentCommunityID, dto.IdPerson, ItemType.Path, 0, DateTime.Now, False, "PathSummary", PreloadIsMooc)
            ElseIf dto.CanStat Then
                oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UserStatisticsView(dto.IdPath, Me.CurrentCommunityID, DateTime.Now, False, PreloadIsMooc)
            Else
                oHyp.Visible = False
            End If
            ...
            Me.Resource.setHyperLink(oHyp, False, True)
            oHyp.Text = ""
            oHyp.NavigateUrl = Me.BaseUrl + RootObjectMoocs.EPCertificationUser(Me.CurrentCommunityID, dto.IdPath, dto.IdPerson, dto.IsMooc)
