...
#Region " Base"
    ...
    Public Overrides Sub BindDati()
        ...
        Dim urlViewActivity As String = Me.BaseUrl & RootObjectMoocs.ViewActivity(ActivityId, ServiceEP.GetUnitId_ByActivityId(ActivityId), ServiceEP.GetPathId_ByActivityId(ActivityId), Me.CurrentCommunityID, EpViewModeType.Manage, IsMoocPath, PreloadIsFromReadOnly)
...
#End Region
    ...
    Private Sub ShowError(ByVal ErrorType As EpError)
        ...
        Me.HYPerror.NavigateUrl = Me.BaseUrl & RootObjectMoocs.EduPathList(CurrentCommunityID, EpViewModeType.Manage, IsMoocPath)
    ...
    Private Sub BTNsave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNsave.Click
        ...
        Else
            ...
            Else
                Me.PageUtility.RedirectToUrl(RootObjectMoocs.ViewActivity(ActivityId, ServiceEP.GetUnitId_ByActivityId(ActivityId), ServiceEP.GetPathId_ByActivityId(ActivityId), Me.CurrentCommunityID, EpViewModeType.Manage, IsMoocPath, PreloadIsFromReadOnly))
            End If
        End If
    End Sub
