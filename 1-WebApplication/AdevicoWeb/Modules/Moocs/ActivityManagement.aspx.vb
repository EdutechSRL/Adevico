...
Public Class ActivityManagementMooc
...
#Region " Base"
                ...
                If IsNumeric(Request.QueryString("idQ")) Then
                    ...
                    If IsNumeric(Request.QueryString("owId")) Then
                        ...
                        If currentActivity.isQuiz Then
                            ...
                            End If
                            RedirectToUrl(RootObjectMoocs.ActivityManagement(CurrentActivityID, currentActivity.ParentUnit.Id, ComunitaCorrenteID, StepActivityManagement.Detail, IsMoocPath, PreloadIsFromReadOnly))
                        Else
                            RedirectToUrl(RootObjectMoocs.ViewActivity(CurrentActivityID, currentActivity.ParentUnit.Id, currentActivity.Path.Id, ComunitaCorrenteID, EpViewModeType.Manage, IsMoocPath, PreloadIsFromReadOnly))
                        End If
                    End If
    ...
    Public Overrides Sub SetCultureSettings()
        MyBase.SetCulture("pg_MoocCreate", "EduPath") 'da modificare
    End Sub
...
#Region "Button"
    ...
    Public Sub BTNnext_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Select Case Me.CurrentStep
            Case StepActivityManagement.NewActivity
                If Me.UpdateDetail() Then
                    ...
                    If PersistData() Then 'cancella currentActivity
                        RedirectToUrl(RootObjectMoocs.PathView(PathId, CurrentCommunityID, EpViewModeType.Manage, False, IsMoocPath, PreloadIsFromReadOnly))
                    Else
                        Me.ShowError(EpError.Generic)
                    End If
            ...
            Case StepActivityManagement.SelectPermission
                ...
                Me.PageUtility.RedirectToUrl(RootObjectMoocs.ActivityManagement(CurrentActivityID, Me.UnitID, Me.CurrentCommunityID, StepActivityManagement.Detail, IsMoocPath, PreloadIsFromReadOnly))

            Case StepActivityManagement.SelectPerson
                Me.GetSelectedPerson()
                Me.PageUtility.RedirectToUrl(RootObjectMoocs.ActivityManagement(CurrentActivityID, Me.UnitID, Me.CurrentCommunityID, StepActivityManagement.SelectPermission, IsMoocPath, PreloadIsFromReadOnly))
            Case StepActivityManagement.Update
                If Me.UpdateDetail() Then
                    If Me.ServiceEP.CheckStatus(currentActivity.Status, Status.Draft) Then
                        currentActivity.Status = currentActivity.Status - Status.Draft
    ...
    Public Sub BTNprevious_Click(ByVal sender As Object, ByVal e As EventArgs)
        Select Case Me.CurrentStep
            Case StepActivityManagement.SelectPermission
                Me.GetSelectedPermission()
                Me.PageUtility.RedirectToUrl(RootObjectMoocs.ActivityManagement(currentActivity.Id, Me.UnitID, Me.CurrentCommunityID, StepActivityManagement.Detail, IsMoocPath, PreloadIsFromReadOnly))
            Case StepActivityManagement.SelectPerson
                Me.GetSelectedPerson()
                Me.PageUtility.RedirectToUrl(RootObjectMoocs.ActivityManagement(currentActivity.Id, Me.UnitID, Me.CurrentCommunityID, StepActivityManagement.SelectPermission, IsMoocPath, PreloadIsFromReadOnly))
        End Select
    End Sub
    Public Sub BTNcancel_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        End If
        ClearSession()
        PageUtility.RedirectToUrl(RootObjectMoocs.PathView(PathId, Me.CurrentCommunityID, EpViewModeType.Manage, False, IsMoocPath, PreloadIsFromReadOnly))
    End Sub
    Private Sub BTNselectPerson_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNselectPerson.Click
        Me.GetSelectedPermission()
        Me.PageUtility.RedirectToUrl(RootObjectMoocs.ActivityManagement(currentActivity.Id, Me.UnitID, Me.CurrentCommunityID, StepActivityManagement.SelectPerson, IsMoocPath, PreloadIsFromReadOnly))
    End Sub
#End Region

    'Public Sub SetHelpImg(ByRef oImg As System.Web.UI.WebControls.Image)
    '    'oImg.ImageUrl = RootObjectMoocs.ImgHelp(Me.BaseUrl)
...
#End Region
    ...
    Private Sub BTNerror_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNerror.Click
        Me.ClearSession()
        RedirectToUrl(RootObjectMoocs.PathView(ServiceEP.GetPathId_ByUnitId(UnitID), Me.CurrentCommunityID, EpViewModeType.Manage, False, IsMoocPath, PreloadIsFromReadOnly))
    End Sub
