...
#Region " Base"
    ...
    Public Overrides Sub BindDati()
            ...
            Select Case ViewModeType
                ...
                Case EpViewModeType.View
                    If ServiceEP.isPlayModePath(CurrentPathId) Then
                        RedirectToUrl(RootObjectMoocs.PathView(CurrentPathId, CurrentCommunityID, EpViewModeType.View, True, IsMoocPath, False))
                    End If
                    'UpdateScormStat()
                    InitPageView()
                Case Else
        ...
        Else
            RedirectToUrl(RootObjectMoocs.EduPathList(CurrentPathId, EpViewModeType.View, PreloadIsMooc))
        End If
    End Sub
...
#End Region
    ...
    Private Sub ShowError(ByVal errorType As EpError)
        ...
        Me.HYPerror.NavigateUrl = Me.BaseUrl & RootObjectMoocs.PathView(Me.CurrentPathId, Me.CurrentCommunityID, Me.ViewModeType, ServiceEP.isPlayModePath(CurrentPathId), IsMoocPath, PreloadIsFromReadOnly)
    ...
    Private Sub InitNavigationButton()
        ...
        If Not dtoNextActivity Is Nothing Then
            ...
            Me.HYPnextAct.NavigateUrl = Me.BaseUrl & RootObjectMoocs.ViewActivity(dtoNextActivity.ActivityId, dtoNextActivity.ParentUnitId, Me.CurrentPathId, Me.CurrentCommunityID, Me.ViewModeType, IsMoocPath, False)
        End If
        ...
        If Not dtoPreviousActivity Is Nothing Then
            ...
            Me.HYPpreviousAct.NavigateUrl = Me.BaseUrl & RootObjectMoocs.ViewActivity(dtoPreviousActivity.ActivityId, dtoPreviousActivity.ParentUnitId, Me.CurrentPathId, Me.CurrentCommunityID, Me.ViewModeType, IsMoocPath, False)
        End If
    End Sub
    ...
    Public Sub InitButton()
        ...
        End If
        LKBeduPathView.PostBackUrl = Me.BaseUrl & RootObjectMoocs.PathView(Me.CurrentPathId, Me.CurrentCommunityID, Me.ViewModeType, ServiceEP.isPlayModePath(CurrentPathId), IsMoocPath, PreloadIsFromReadOnly)
    End Sub
    ...
    Private Sub InitActivityDetail(ByRef dtoActivity As dtoActivity, ByVal forManage As Boolean)
        ...
        If dtoActivity.PermissionEP.Update AndAlso isManageable Then
            ...
            Me.HYPupdateAct.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UpdateActivity(Me.CurrentCommunityID, Me.CurrentActivityID, Me.CurrentUnitId, IsMoocPath, False)
        ...
        If ServiceEP.CheckStatus(dtoActivity.Status, Status.Mandatory) Then
            Me.IMGactMandatory.ImageUrl = RootObjectMoocs.ImgMandatoryMedium(Me.BaseUrl)
            ...
            Select Case e.CommandName
                ...
                Case "delete"
                    If ServiceEP.VirtualDeleteSubActivity(e.CommandArgument, Me.CurrentCommunityID, Me.CurrentUserId, OLDpageUtility.ClientIPadress, OLDpageUtility.ProxyIPadress) Then
                        Me.PageUtility.RedirectToUrl(RootObjectMoocs.ViewActivity(Me.CurrentActivityID, Me.CurrentUnitId, Me.CurrentPathId, Me.CurrentCommunityID, Me.ViewModeType, IsMoocPath, PreloadIsFromReadOnly))
                    Else
    ...
    Private Sub RPsubActivity_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles RPsubActivity.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            Select Case Me.ViewModeType
                Case EpViewModeType.Manage
                    ...
                    If Me.CanSwichSubAct Then
                        ...
                        oLkb.Visible = True
                        oLkb.Text = String.Format(oLkb.Text, RootObjectMoocs.ImgUpActive(Me.BaseUrl), oLkb.ToolTip)
                        ...
                        oLkb.Text = "<img src=" & """" & "{0}" & """" & " alt=" & """" & "{1}" & """" & "/>"
                        oLkb.Visible = True
                        oLkb.Text = String.Format(oLkb.Text, RootObjectMoocs.ImgDownActive(Me.BaseUrl), oLkb.ToolTip)
                                ...
                                If ServiceEP.isSubActityInternalModule(dtoItem.ContentType) Then
                                    ...
                                    Select Case dtoItem.ContentType
                                        Case SubActivityType.Text
                                            oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UpdateSubActText(dtoItem.Id, Me.CurrentActivityID, Me.CurrentCommunityID, IsMoocPath, PreloadIsFromReadOnly)
                                        Case SubActivityType.Certificate
                                            oHyp.NavigateUrl = Me.BaseUrl & RootObjectMoocs.UpdateSubActCertification(Me.CurrentPathId, Me.CurrentUnitId, Me.CurrentActivityID, dtoItem.Id, Me.CurrentCommunityID, IsMoocPath, PreloadIsFromReadOnly)
                ...
                Case EpViewModeType.View
                    ...
                    oImg.Visible = True
                    oImg.ImageUrl = RootObjectMoocs.ImgItemBlocked(Me.BaseUrl, isPlayMode)
            ...
            oImg.ImageUrl = RootObjectMoocs.ImgContentType(Me.BaseUrl, dtoItem.ContentType)
    ...
    Private Sub LKBdeleteAct_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LKBdeleteAct.Click
        ...
        Me.PageUtility.RedirectToUrl(RootObjectMoocs.PathView(CurrentPathId, CurrentCommunityID, EpViewModeType.Manage, False, IsMoocPath, PreloadIsFromReadOnly))
    End Sub
...
#Region "ADD"
    ...
    Protected Sub CTRLaddAction_UpdateAndCloseContainer(ByVal idSubactivity As Long) Handles CTRLaddAction.UpdateAndCloseContainer
        ...
        'Me.BindDati()+
        PageUtility.RedirectToUrl(RootObjectMoocs.ViewActivity(idSubactivity, Me.CurrentActivityID, Me.CurrentUnitId, Me.CurrentPathId, Me.CurrentCommunityID, EpViewModeType.Manage, IsMoocPath, PreloadIsFromReadOnly))
    End Sub
...
#Region "GESTIONE DIALOG ATTUALMENTE ELIMINATE... IN CASO DI MODIFICA GESTIVANO SE AGGIORNARE LE STATISTICHE O PERSONALIZZARE GLI ASSEGNAMENTI DI CHI HA GIA' INIZIATO IL PERCORSO"
    ...
    '            Me.PageUtility.RedirectToUrl(RootObjectMoocs.ViewActivity(Me.CurrentActivityID, Me.CurrentUnitId, Me.CurrentPathId, Me.CurrentCommunityID, Me.ViewModeType))
    '        Else
    '            ShowError(EpError.Generic)
    '        End If
    '    End If
    ...
    Private Sub CTRLaddVersion_AddVersion(idItem As Long, file As lm.Comol.Core.FileRepository.Domain.dtoUploadedItem) Handles CTRLaddVersion.AddVersion
        ...
        Select Case result
            Case lm.Comol.Core.BaseModules.FileRepository.Domain.VersionErrors.none
                PageUtility.RedirectToUrl(RootObjectMoocs.ViewActivity(Me.CurrentActivityID, Me.CurrentUnitId, Me.CurrentPathId, Me.CurrentCommunityID, EpViewModeType.Manage, IsMoocPath, PreloadIsFromReadOnly))
            Case Else
