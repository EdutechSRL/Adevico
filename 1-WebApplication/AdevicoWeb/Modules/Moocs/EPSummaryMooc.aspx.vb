...
#Region "Implements"
    ...
    Private Sub DisplaySessionTimeout() Implements IViewSummaryPath.DisplaySessionTimeout
        ...
        dto.DestinationUrl = lm.Comol.Modules.EduPath.BusinessLogic.RootObjectMoocs.SummaryPath(PreloadFromSummary, PreloadIdCommunity)
...
#Region "Repeater"
    Private Sub RPTpaths_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles RPTpaths.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            hyp.NavigateUrl = BaseUrl & RootObjectMoocs.PathStatistics(dto.IdPath, dto.IdCommunity, DateTime.Now, False, SummaryType.Path, SummaryIdCommunity, FromSummary, dto.IsMooc)

            hyp.Visible = dto.CanStat

            hyp = e.Item.FindControl("HYPedit")
            hyp.NavigateUrl = BaseUrl & RootObjectMoocs.PathView(dto.IdPath, dto.IdCommunity, EpViewModeType.Manage, False, dto.IsMooc)
    ...
    Private Sub RPTcommunitypaths_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            hyp.NavigateUrl = BaseUrl & RootObjectMoocs.PathStatistics(dto.IdPath, dto.IdCommunity, DateTime.Now, False, dto.IsMooc)
