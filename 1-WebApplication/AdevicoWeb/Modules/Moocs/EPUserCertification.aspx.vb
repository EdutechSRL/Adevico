...
Public Class EPUserCertificationMooc
...
#End Region
    ...
    Public Overrides Sub BindDati()
        ...
        If (CurrentIdCertificate > 0) Then
            HYPback.NavigateUrl = BaseUrl + RootObjectMoocs.EPCertification(CurrentPathIdCommunity, CurrentIdPath, CurrentIdCertificate, IsMoocPath)
        Else
            HYPback.NavigateUrl = BaseUrl + RootObjectMoocs.EPCertificationList(CurrentPathIdCommunity, CurrentIdPath, IsMoocPath)
        End If
    ...
    Private Sub RPTcertificates_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles RPTcertificates.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            ...
            lnb.NavigateUrl = BaseUrl + RootObjectMoocs.EPCertification(dto.CommunityId, dto.PathId, dto.CertificateId, IsMoocPath)
