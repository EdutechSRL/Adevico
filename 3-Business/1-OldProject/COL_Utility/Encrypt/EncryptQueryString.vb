...
Public Class EncryptQueryString
    ...
    Public Function DecryptSMARTVerifyURL(ByVal querystring As System.Collections.Specialized.NameValueCollection) As Integer
        Dim hash As String = "1"
        Dim data As String = "2"
        Dim ok As Boolean = True
        Dim strArr As String()
        Try
            strArr = querystring(0).Split("|")
            data = strArr(0).Replace(" ", "+")
            hash = (strArr(1).Replace(" ", "+")).Split("=")(1) & "=="
        Catch ex As Exception
            ok = False
        End Try
    ...
    Public Function rndgen(ByVal numcar As Integer) As String
        RandomGenerator.KeyChars = numcar
        Return RandomGenerator.Generate()
    End Function

    Public Function rndgen() As String
        Return RandomGenerator.Generate()
    End Function
