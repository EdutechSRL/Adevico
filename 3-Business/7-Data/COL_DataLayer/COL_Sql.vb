Public Class COL_SqlDataReader : Inherits COL_DataReader
...
Public Class COL_SqlDataSet : Inherits COL_DataSet
...
Public Class COL_SQLExecuteNotQuery : Inherits COL_ExecuteNotQuery
