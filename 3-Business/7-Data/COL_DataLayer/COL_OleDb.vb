Public Class COL_OleDbDataReader : Inherits COL_DataReader
...
Public Class COL_OleDbDataSet : Inherits COL_DataSet
...
Public Class COL_OleDbExecuteNotQuery : Inherits COL_ExecuteNotQuery
