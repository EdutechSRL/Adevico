using lm.Comol.Core.Msmq.Services.Notifications.Service;
using NLog;
using System;
...
namespace lm.Comol.Core.Msmq.Services.Notifications.ConsoleHost
{
    class Program
    {
        ...
        private static void Work()
        {
            ...
            Type serviceType = typeof(NotificationsService);
