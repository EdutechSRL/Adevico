...
{
    [DataContract]
    public class IMMessagesContainerDTO:IMDomainObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Messaggi della chat corrente
        /// </summary>
        [DataMember]
        public IList<IMMessageDTO> Messages { get; set; }

        ///// <summary>
        ///// Messaggi della chat corrente
        ///// </summary>
        //[DataMember]
        //public override Int32 MessagesCount {
        //    get {
        //        Int32 Count = 0;
        //        try { 
