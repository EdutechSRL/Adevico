Namespace Business
    Public Class CacheTime
        Public Shared Function Scadenza30secondi() As TimeSpan
            Return New TimeSpan(0, 0, 30)
        End Function
        Public Shared Function Scadenza2minuti() As TimeSpan
            Return New TimeSpan(0, 2, 0)
        End Function
        Public Shared Function Scadenza5minuti() As TimeSpan
            Return New TimeSpan(0, 5, 0)
        End Function
        Public Shared Function Scadenza10minuti() As TimeSpan
