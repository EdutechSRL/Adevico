...
namespace FileTransfer.Core
{
    ...
    public class StandardServiceHost : BaseStandardServiceHost<FileTransfer.Core.FileMQService>
    {
        public StandardServiceHost()
        {
            ServiceName = "FileMQService";
        }
        ...
        public void StartService(){
            try
            {
                ...
                MyServiceHost = new ServiceHost(typeof(FileTransfer.Core.FileMQService));
