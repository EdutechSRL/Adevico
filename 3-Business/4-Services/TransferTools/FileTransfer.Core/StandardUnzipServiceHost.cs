...
namespace FileTransfer.Core
{
    ...
    public class StandardUnzipServiceHost:BaseStandardServiceHost<FileTransfer.Core.UnzipMQService>
    {
        public StandardUnzipServiceHost()
        {
            ServiceName = "UnzipMQService";
        }
        ...
        //        MyServiceHost = new ServiceHost(typeof(FileTransfer.Core.UnzipMQService));
