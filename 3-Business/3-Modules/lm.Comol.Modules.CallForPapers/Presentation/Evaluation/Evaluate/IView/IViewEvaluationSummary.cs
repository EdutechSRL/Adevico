...
namespace lm.Comol.Modules.CallForPapers.Presentation.Evaluation
{
    public interface IViewEvaluationSummary : IViewBase
    {
        ...
        void LoadSubmissionInfo(String callName, String submitterName, DateTime? submittedOn, String submittedBy, List<dtoCommitteeEvaluationInfo> committees, long idCommittee);
