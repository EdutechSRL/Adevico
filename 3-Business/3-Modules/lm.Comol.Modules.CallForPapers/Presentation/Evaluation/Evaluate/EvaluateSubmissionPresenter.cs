    ...
    public class EvaluateSubmissionPresenter : lm.Comol.Core.DomainModel.Common.DomainPresenter
    {
        ...
        public void InitView(Boolean forPublicCall)
        {
            ...
            Boolean allowAdmin = ((module.ManageCallForPapers || module.Administration || ((module.CreateCallForPaper || module.EditCallForPaper) && call.Owner.Id == idUser)));
                Boolean isEvaluator = Service.isEvaluationOwner(idEvaluation, UserContext.CurrentUserID);
                ...
                {
                    lm.Comol.Modules.CallForPapers.Domain.Evaluation.dtoEvaluation evaluation = Service.GetFullEvaluation(idEvaluation, View.AnonymousOwnerName, View.UnknownDisplayname);
                    if (evaluation == null)
        ...
        public void SaveEvaluation(List<lm.Comol.Modules.CallForPapers.Domain.Evaluation.dtoCriterionEvaluated> criteria, String comment, Boolean completed)
        {
            if (UserContext.isAnonymous)
                View.DisplaySessionTimeout(RootObject.EvaluateSubmission(View.IdCall, View.PreloadIdCommunity, View.PreloadedIdEvaluation));
            else {
                ...
                try
                {
                    ...
                    evaluation = Service.SaveEvaluation(idEvaluation, idEvaluator, criteria, comment, completed);
                    if (evaluation == null)
                ...
                LoadEvaluationData(idCall, Service.GetFullEvaluation(idEvaluation, View.AnonymousOwnerName, View.UnknownDisplayname));
            }
        }
    }
}