...
namespace lm.Comol.Modules.CallForPapers.Presentation
{
    public class ViewPublicSubmissionPresenter : lm.Comol.Core.DomainModel.Common.DomainPresenter
    {
        ...
        private void LoadSections(BaseForPaper call, dtoSubmissionRevision subRev, Boolean allowAdmin)
        {
            ...
            View.InitializeExportControl((subRev.Owner != null && UserContext.CurrentUserID == subRev.Owner.Id),(subRev.Owner != null) ? subRev.Owner.Id : 0, call.Id, subRev.Id, View.IdRevision, View.IdCallModule, View.IdCallCommunity, View.CallType);
        }
