...
namespace lm.Comol.Modules.CallForPapers.Presentation
{
    public class SubmitCallPresenter : lm.Comol.Core.DomainModel.Common.DomainPresenter
    {
        ...
        public void SaveSubmission(List<dtoSubmissionValueField> fields)
        {
            UserSubmission submission = Service.GetUserSubmission(View.IdSubmission);
            if (submission == null || submission.AllowEditSubmission(View.InitSubmissionTime))
            {
                ...
                View.GoToUrl(CallStandardAction.None, RootObject.ViewSubmission(submission.Call.Type, submission.Call.Id, submission.Id, View.FromPublicList, CallStatusForSubmitters.Submitted, View.PreloadIdOtherCommunity));
            else
        ...
        public void SaveCompleteSubmission(List<dtoSubmissionValueField> fields, lm.Comol.Core.MailCommons.Domain.Configurations.SmtpServiceConfig smtpConfig, String websiteUrl, Dictionary<SubmissionTranslations, string> translations, String BaseFilePath, String translationFileName)
        {
            long idSubmission = this.View.IdSubmission;
            long idCall = View.IdCall;
            UserSubmission submission = Service.GetUserSubmission(View.IdSubmission);
            ...
            if (submission == null || submission.AllowEditSubmission(View.InitSubmissionTime))
            {
                ...
                if ((submission != null || submission.AllowEditSubmission(View.InitSubmissionTime)) && revision!=null)
                {
                    ...
                    try
                    {
                        ...
                        if (submission.Owner.Id == idUser)
                        {
                            ...
                            Service.UserCompleteSubmission(submission, revision, View.InitSubmissionTime, idUser, BaseFilePath, fields, smtpConfig, websiteUrl,translations, translationFileName);
                            View.AllowCompleteSubmission = false;
                            View.AllowDeleteSubmission = false;
                            View.AllowSave = false;
                ...
                View.GoToUrl(CallStandardAction.None, RootObject.ViewSubmission(CallForPaperType.CallForBids, idCall, idSubmission, View.FromPublicList, CallStatusForSubmitters.Submitted, View.PreloadIdOtherCommunity));
            else
        ...
        public void RemoveSubmittedFile(long idSubmittedFile,List<dtoSubmissionValueField>fields)
        {
            UserSubmission submission = Service.GetUserSubmission(View.IdSubmission);
            if (submission == null)
                View.GoToUrl(CallStandardAction.List, RootObject.ViewCalls(View.IdCall, CallForPaperType.CallForBids, CallStandardAction.List, View.IdCallCommunity, CallStatusForSubmitters.SubmissionClosed));
            else if (submission.AllowEditSubmission(View.InitSubmissionTime))
            {
                ...
                this.SaveSubmission(fields);
            }
            else
                View.GoToUrl(RootObject.ViewSubmission(submission.Call.Type, submission.Call.Id, submission.Id, View.FromPublicList, CallStatusForSubmitters.Submitted, View.PreloadIdOtherCommunity));
