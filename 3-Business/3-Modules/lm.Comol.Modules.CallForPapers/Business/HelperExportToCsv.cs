        ...
        #region "evaluations"
            public String ExportEvaluatorStatistics(dtoCall call, List<lm.Comol.Modules.CallForPapers.Domain.Evaluation.dtoEvaluatorCommitteeStatistic> statistics, litePerson person)
            {
                ...
                foreach (lm.Comol.Modules.CallForPapers.Domain.Evaluation.dtoEvaluatorCommitteeStatistic committee in statistics)
                {
                    ...
                    AppendToRow(sBuilder, string.Format(EvaluationsTranslations[Domain.Evaluation.EvaluationTranslations.CommitteeName], committee.Name),false);
                    ...
                    committee.Criteria.Where(c => ( c.Type == Domain.Evaluation.CriterionType.StringRange || c.Type== CriterionType.RatingScale || c.Type== CriterionType.RatingScaleFuzzy) && c.Options.Any()).ToList().ForEach(c => options.AddRange(c.Options));
                    ...
                    committee.Evaluations.ForEach(e => AddEvaluationStatisticRow(sBuilder, call.EvaluationType,committee.IsFuzzy,validEvaluations, committee.Criteria, options, e));
            ...
            private void AddEvaluationStatisticRow(StringBuilder sBuilder, EvaluationType type, Boolean isFuzzyCommittee, Boolean displayRating,List<lm.Comol.Modules.CallForPapers.Domain.Evaluation.dtoCriterion> criteria, List<dtoCriterionOption> availableOptions, lm.Comol.Modules.CallForPapers.Domain.Evaluation.dtoEvaluation evaluation)
            {
                //String row = "";
