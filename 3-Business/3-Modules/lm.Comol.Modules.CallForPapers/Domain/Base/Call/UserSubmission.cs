...
namespace lm.Comol.Modules.CallForPapers.Domain
{
    ...
    public class UserSubmission : DomainBaseObjectLiteMetaInfo<long>
    {
        ...
        public virtual Boolean AllowEditSubmission(DateTime initDate)
        {
            return Call.AllowLateSubmission(initDate, ExtensionDate) && (Status == SubmissionStatus.none || Status == SubmissionStatus.draft);
        }
