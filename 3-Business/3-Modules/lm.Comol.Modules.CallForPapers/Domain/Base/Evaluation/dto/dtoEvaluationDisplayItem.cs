...
namespace lm.Comol.Modules.CallForPapers.Domain.Evaluation
{
    ...
    public class dtoEvaluationSummaryItem : dtoBaseSummaryItem
    {
        ...
        public virtual double AverageRating { get { return Evaluations.Where(e => e.Status != EvaluationStatus.EvaluatorReplacement && e.Status != EvaluationStatus.Invalidated).Select(e => e.AverageRating).Average(); } }
    ...
    public class dtoCommitteesSummaryItem : dtoBaseSummaryItem
    {
        ...
        public virtual DssCallEvaluation DssEvaluation { get; set; }
        public virtual double DssRanking { get { return (DssEvaluation != null ? DssEvaluation.Ranking : 0); } }
        public virtual double AverageRating { get { return (Committees == null || Committees.Count == 0) ? 0 : Committees.Select(e => e.AverageRating).Average(); } }
    ...
    public class dtoCriterionSummaryItem : dtoCriterion 
    {
        ...
        {
            Evaluations = (from e in evaluators.OrderBy(e => e.EvaluatorName).ThenBy(e => e.IdMembership).ToList()
