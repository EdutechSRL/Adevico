...
{
    public class TaskMultipleUploadPresenter : lm.Comol.Core.DomainModel.Common.DomainPresenter
    {
        ...
        protected virtual IViewTaskMultipleUpload View
        {
            get { return (IViewTaskMultipleUpload)base.View; }
        }
        ...
        public TaskMultipleUploadPresenter(iApplicationContext oContext):base(oContext){
            this.CurrentManager = new BaseModuleManager(oContext);
        }
        public TaskMultipleUploadPresenter(iApplicationContext oContext, IViewTaskMultipleUpload view)
            : base(oContext, view)
        {
            this.CurrentManager = new BaseModuleManager(oContext);
        }
