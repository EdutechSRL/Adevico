...
Namespace lm.Comol.Modules.UserActions.Presentation
    Public Class UserSystemCommunityStatisticsPresenter
...
#Region "Standard"
        ...
        Public Overloads Property CurrentManager() As ManagerUsageStatistic
            ...
            End Set
        End Property
        Public Overloads ReadOnly Property View() As IViewUserSystemCommunityStatistics
            Get
                Return MyBase.View
            End Get
        End Property
        ...
        End Sub
        Public Sub New(ByVal oContext As iApplicationContext, ByVal view As IViewUserSystemCommunityStatistics)
...
#End Region
        ...
        Public Sub LoadCommunityUser(ByVal oUsage As UsageContext, p As ModuleStatistics)
            ...
            View.SendAction(0, UserContext.CurrentUserID, oUsage.UserID, oUsage.CommunityID, ModuleStatistics.ActionType.LoadPortalUserCommunityStatistics)
        End Sub
        ...
        Private Function GetDefaultContext() As UsageContext
            ...
            End If
            oContext.ModuleID = -2
            If oContext.UserID < 1 OrElse Me.View.PreloadedFromView = StatisticView.MySystem Then
