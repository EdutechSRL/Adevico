...
Namespace lm.Comol.Modules.UserActions.Presentation
    Public Class MyCommunityStatisticsPresenter
...
#Region "Standard"
        ...
        Public Overloads Property CurrentManager() As ManagerUsageStatistic
            ...
            End Set
        End Property
        Public Overloads ReadOnly Property View() As IViewMyCommunityStatistics
            Get
                Return MyBase.View
            End Get
        End Property
        ...
        End Sub
        Public Sub New(ByVal oContext As iApplicationContext, ByVal view As IViewMyCommunityStatistics)
...
#End Region
        ...
        Public Sub InitView()
            If Not Me.UserContext.isAnonymous Then
                ...
                If IsNothing(user) Then
                    ...
                    View.SendAction(UserContext.CurrentCommunityID, UserContext.CurrentUserID, oContext.UserID, ModuleStatistics.ObjectType.User, ModuleStatistics.ActionType.UserNotFound)
                Else
                    ...
                    ElseIf items.Contains(StatisticView.MyCommunity) Then
                        LoadCommunityUser(oContext, p)
                    Else
                        View.LoadView(items.FirstOrDefault())
                    End If
                End If
        ...
        Public Sub LoadCommunityUser(ByVal oUsage As UsageContext, p As ModuleStatistics)
            ...
            View.SendAction(UserContext.CurrentCommunityID, UserContext.CurrentUserID, oUsage.CommunityID, ModuleStatistics.ObjectType.Community, ModuleStatistics.ActionType.LoadCommunityMyPersonalStatistics)
        End Sub
